	...
	var Config = function (_React$Component) {
	    ...
	    _createClass(Config, [{
	        ...
	        value: function componentDidMount() {
	            var that = this;
	            _axios2.default.get('/api/config').then(function (response) {
	        ...
	        value: function saveConfig() {
	            ...
	            var that = this;
	            _axios2.default.post('/api/config', payload).then(function (response) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'row', style: { "minHeight": "20%", "marginBottom": "0" } },
	                            _react2.default.createElement('br', null),
	                            this.state.restart ? _react2.default.createElement(
	                                'h6',
	                                { style: { "marginLeft": "20px", "textAlign": "centre", "color": "red" } },
	                                'Restart the flask server to see the changes'
	                            ) : null,
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'input-field col s4' },
	                                _react2.default.createElement('input', { type: 'text', value: this.state.name, id: 'bot_name', onChange: this.nameChange }),
	                                _react2.default.createElement(
	                                    'label',
	                                    { htmlFor: 'bot_name', className: 'active' },
	                                    'Bot Name'
	                                )
	                            ),
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'input-field col s4' },
	                                _react2.default.createElement('input', { type: 'text', value: this.state.author, id: 'author_name', onChange: this.authorChange }),
	                                _react2.default.createElement(
	                                    'label',
	                                    { htmlFor: 'author_name', className: 'active' },
	                                    'Author Name'
	                                )
	                            ),
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'input-field col s4' },
	                                _react2.default.createElement('input', { type: 'text', value: this.state.config_route, id: 'config_route', onChange: this.configChange }),
	                                _react2.default.createElement(
	                                    'label',
	                                    { htmlFor: 'config_route', className: 'active' },
	                                    'Config Route'
	                                )
	                            ),
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'a',
	                                    { className: 'waves-effect waves-light btn', style: { "backgroundColor": "black" }, onClick: this.saveConfig },
	                                    this.state.button
	                                )
	                            )
	                        ),
	                        _react2.default.createElement('div', { className: 'row', style: { "backgroundColor": "green", "minHeight": "80%" } })
	                    ),
